...
%________________________________________________________________________________________________________________________
%
%   Purpose: Link binary events together that occur within a defined amount of time.
%________________________________________________________________________________________________________________________
%
%   Inputs: binWF (double) array of the binarized values.
%           dCrit (double) values corresponding to that periods events should occur within to be linked as one.
%
%   Outputs: linkWF (double) array of the now-linked binarized values.
%
...
dBinWF = diff(gt(binWF, 0));   % Re-establish state change indecies.
