function [AnalysisResults] = Fig5_GheresTBD(rootFolder,saveFigs,AnalysisResults)
...
for a = 1:length(IOSanimalIDs)
    ...
    for b = 1:length(dataTypes)
        ...
        for d = 1:length(solenoidNames)
            ...
            if isfield(AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName),'count') == true
                data.(dataType).(solenoidName).count(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).count;
                data.(dataType).(solenoidName).HbT(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).CBV_HbT.HbT;
                data.(dataType).(solenoidName).CBV(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).CBV.CBV;
                data.(dataType).(solenoidName).cortMUA(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).MUA.corticalData;
                data.(dataType).(solenoidName).hipMUA(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).MUA.hippocampalData;
                data.(dataType).(solenoidName).cortGam(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).Gam.corticalData;
                data.(dataType).(solenoidName).hipGam(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).Gam.hippocampalData;
                data.(dataType).(solenoidName).timeVector(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).timeVector;
                data.(dataType).(solenoidName).cortS(:,:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.corticalS;
                data.(dataType).(solenoidName).cortS_Gam(:,:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.corticalS(49:end,20:23);
                data.(dataType).(solenoidName).hipS(:,:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.hippocampalS;
                data.(dataType).(solenoidName).hipS_Gam(:,:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.hippocampalS(49:end,20:23);
                data.(dataType).(solenoidName).T(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.T;
                data.(dataType).(solenoidName).F(:,a) = AnalysisResults.(animalID).EvokedAvgs.REMawake.(dataType).(solenoidName).LFP.F;
            end
        end
    end
end
